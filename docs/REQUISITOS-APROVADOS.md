...
- No envio de arte livre, o painel recomenda imagem horizontal de 1600 × 900 px com o assunto centralizado, mas aceita os demais tamanhos permitidos. O enquadramento público prioriza o topo da fotografia.
...
- A publicação exige nome, preço maior que zero, exatamente uma foto principal e permite fotos secundárias. Quando houver promoção, o preço promocional deve ser menor que o normal.
...
- Sobre possui uma página dedicada e sem caixas auxiliares: a apresentação fica à esquerda e um texto natural sobre a proposta e o atendimento fica à direita no desktop.
